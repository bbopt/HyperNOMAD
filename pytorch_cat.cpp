...
{    
	...
	int n = static_cast<int> (x[0].value());
        ...
        // const Point & d0_curr = _p.get_initial_poll_size();
        ...
        if (n<20){
            ...
            // lb_1[index_m + shift1] = lb_curr[index_m];
            // ub_1[index_m + shift1] = ub_curr[index_m];
        ...
        if (n>0){
            ...
            // _vector_signature.push_back(_s2);
        ...
        if(m<20){
            ...
            for ( int i = index_m + 1 + 1 ; i < dim3 ; i++ ){
