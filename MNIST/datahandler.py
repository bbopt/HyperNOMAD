...
class DataHandler(object):
    def __init__(self, dataset, batch_size):
        ...
        available_datasets = ['MNIST', 'Fashion-MNIST', 'KMNIST', 'EMNIST', 'CIFAR10', 'CIFAR100', 'STL10', 'SVHN',
                              'PhotoTour',
                              'SBU', 'Flickr', 'VOC', 'Cityscapes', 'CUSTOM']
    ...
    def get_loaders(self):
        ...
        if self.dataset in ['MNIST', 'Fashion-MNIST', 'KMNIST', 'EMNIST']:
            ...
            if self.dataset == 'Fashion-MNIST':
                ...
                trainset = torchvision.datasets.FashionMNIST(root, train=True, transform=None, target_transform=None, download=True)
                testset = torchvision.datasets.FashionMNIST(root, train=False, transform=None, target_transform=None, download=True)
            if self.dataset == 'KMNIST':
                print(">>> Preparing KMNIST dataset...")
                trainset = torchvision.datasets.KMNIST(root, train=True, transform=None, target_transform=None, download=True)
                testset = torchvision.datasets.KMNIST(root, train=False, transform=None, target_transform=None, download=True)
            if self.dataset == 'EMNIST':
                print(">>> Preparing EMNIST dataset...")
                trainset = torchvision.datasets.EMNIST(root, train=True, transform=None, target_transform=None,
                                                       download=True)
                testset = torchvision.datasets.EMNIST(root, train=False, transform=None, target_transform=None,
                                                      download=True)
